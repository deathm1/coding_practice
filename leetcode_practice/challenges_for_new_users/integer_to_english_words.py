class integer_to_english_words():
    def numberToWords(self, num: int) -> str:
        ...
        d = {
            ...
            2:'Two',
            1:'One'
        } #initiating a dictionary to handle number to word mapping
        ...
        for key, value in d.items():  #for loop to iterate through each key-value pair in dictionary 
            if num//key>0 :           #checking if number is in the range of current key
                x = num//key
                print(x)          #finding the multiple of key in num
...
my_objs = integer_to_english_words()
print(my_objs.numberToWords(1234))